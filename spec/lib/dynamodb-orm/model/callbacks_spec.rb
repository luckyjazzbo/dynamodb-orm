...
RSpec.describe DynamodbOrm::Model::Callbacks do
  include_context(
    'with dynamodb table',
    :sample_table,
  ...
  context 'before_create' do
    class ModelWithBeforeCreateCallback < DynamodbOrm::Model
  ...
  context 'before_save' do
    class ModelWithBeforeSaveCallback < DynamodbOrm::Model
      table name: :sample_table
      field :counter
  ...
  context 'timestamps' do
    class ModelWithTimestamps < DynamodbOrm::Model
