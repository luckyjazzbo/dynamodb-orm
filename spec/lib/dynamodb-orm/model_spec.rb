...
RSpec.describe DynamodbOrm::Model do
  include_context(
    'with dynamodb table',
    'movies',
  ...
  describe '#primary_key' do
    class TableWithCustomPrimaryKey < DynamodbOrm::Model
  ...
  describe 'attribute readers' do
    class ModelWithAttrReaders < DynamodbOrm::Model
      field :title, type: :string
  ...
  describe '#save!' do
    ...
    context 'when cannot be saved' do
      it 'raises exception' do
        expect {
          movie.save!
        }.to raise_error DynamodbOrm::GenericError
      end
    end
  end
  ...
  describe '.table_name' do
    ...
    context 'when is assigned' do
      class FunnyMovie < DynamodbOrm::Model
  ...
  describe '.find!' do
    ...
    context 'when document does not exist' do
      it 'throws exception' do
        ...
        }.to raise_error(DynamodbOrm::RecordNotFound)
      end
    end
  end
  ...
  describe '.count' do
    context 'when table does not exist' do
      class ModelWithNoTable < DynamodbOrm::Model; end

      it 'raise exception' do
        expect {
          ModelWithNoTable.count
        }.to raise_error(DynamodbOrm::TableDoesNotExist)
      end
    end
  end
  ...
  describe '#reload!' do
    ...
    context 'without id' do
      ...
      it 'raises error' do
        expect { movie.reload! }.to raise_error DynamodbOrm::InvalidQuery
      end
    end
  end
end
